  ...
  Widget createFriendTile({BuildContext context, Friend friend, DatabaseService databaseService}) {
    ...
    return Padding(
      ...
      child: ListTile(
          ...
          title: Column(
            children: <Widget>[
              Text(friend.fullName, style: TextStyle(color: Colors.cyan[600], fontWeight: FontWeight.bold, fontSize: 20)),
              Text(
          ...
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15), side: BorderSide(width: 2, color: Colors.blueGrey)),
          trailing: IconButton(
            icon: Icon(
    ...
    return FutureBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(child: CustomThreeInOut(color: Colors.white, size: 50.0));
          } else if (snapshot.connectionState == ConnectionState.none) {
            // check if request is empty
            return Text(
              "No connection!",
              style: TextStyle(color: Colors.cyan[300], fontSize: 20, fontStyle: FontStyle.italic, letterSpacing: 1.5),
            );
          }
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
                    Padding(
                      ...
                      child: ElevatedButton(
                          ...
                          child: Icon(Icons.qr_code_scanner_sharp, color: Colors.cyan[300], size: width / 25)),
                    ),
                    Padding(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(color: Colors.white, fontSize: 30.0, fontWeight: FontWeight.bold, fontStyle: FontStyle.italic),
                                ),
                              ),
                            ],
                          ),
                      ...
                      child: friendsList.isNotEmpty
                          ? ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int i) {
                                return createFriendTile(context: context, friend: friendsList[i], databaseService: databaseService);
                              },
