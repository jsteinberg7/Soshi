...
class _SMCardState extends State<SMCard> {
  ...
  Widget build(BuildContext context) {
    ...
    } else if (platformName == "Linkedin" || platformName == "Facebook" || platformName == "Tiktok") {
      hintText = "Link to Profile";
    } else {
      hintText = "Username";
    }
    databaseService = new DatabaseService(soshiUsernameIn: soshiUsername); // store ref to databaseService
      ...
      children: [
        Card(
          shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(10.0), side: (isSwitched == true) ? BorderSide(color: Colors.blueGrey) : BorderSide.none),
          elevation: 10,
          ...
          child: Container(
            ...
            child: Row(
              children: <Widget>[
                Switch(
                    activeThumbImage: AssetImage('assets/images/SoshiLogos/soshi_icon.png'),
                    inactiveThumbImage: AssetImage('assets/images/SoshiLogos/soshi_icon_marble.png'),
                    value: isSwitched,
...
class ProfileState extends State<Profile> {
  ...
  void initState() {
    ...
    bioFocusNode.addListener(() {
      if (!bioFocusNode.hasFocus) {
        ...
        tempDB.updateBio(LocalDataService.getLocalUsernameForPlatform("Soshi"), personalBioTextController.text);
  ...
  Widget build(BuildContext context) {
    double height = Utilities.getHeight(context);
    double width = Utilities.getWidth(context);
    TextEditingController personalBioTextController = new TextEditingController();
                    ...
                    ElevatedButton(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(width: 4.0),
                          Icon(Icons.person_rounded, color: Colors.cyan[300], size: 20.0),
                        ],
                      ),
                    ),
                  ],
                  ...
                  child: SizedBox(
                    ...
                    child: Container(
                      child: TextField(
                          ...
                          style: TextStyle(height: 1.2, fontWeight: FontWeight.bold, fontSize: 15, color: Colors.white, letterSpacing: 1.5),
                          decoration: InputDecoration(
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(fixedSize: Size(35, 35), primary: Colors.blueGrey[500], shape: CircleBorder()),
                    onPressed: () {
                      showDialog(
                          context: context,
                          builder: (BuildContext context) {
                ...
                child: (profilePlatforms == null || profilePlatforms.isEmpty == true)
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          print("creating listView: index: $index soshiUsername: $soshiUsername SMPlatform: $profilePlatforms[index]");
                          return Padding(
                ...
                child: ElevatedButton(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text('Add Platforms!', style: TextStyle(fontSize: 14, color: Colors.cyan[300], letterSpacing: 3.0, fontWeight: FontWeight.bold))
                    ],
                  ),
                ),
              )
