          ...
          child: Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                SizedBox(width: 5),
                ['Email', 'Phone', 'Contact', 'Linkedin', 'Tiktok', 'Facebook'].contains(platformName)
                    ? Container()
                    : Padding(
                ...
                Expanded(
                    child: TextField(
                  autofillHints: ['Phone'].contains(platformName) ? [AutofillHints.telephoneNumber] : null,
                  keyboardType: ["Phone"].contains(platformName)
                      ? TextInputType.numberWithOptions(signed: true, decimal: true)
                      : (["Email"].contains(platformName) ? TextInputType.emailAddress : null),
...
class ProfileState extends State<Profile> {
  ...
  TextEditingController profileBioController = TextEditingController(text: LocalDataService.getBio().toString());
                    ...
                    child: ElevatedButton(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Text('Add Platforms!',
                              style: TextStyle(fontSize: 14, color: Colors.cyan[300], letterSpacing: 3.0, fontWeight: FontWeight.bold))
                        ],
                      ),
                    ),
                  )
