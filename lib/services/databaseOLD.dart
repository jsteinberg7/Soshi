...
//         emailIn: DataEngine.globalUser.getUsernameGivenPlatform(platform: "Email"),
//         phoneIn: DataEngine.globalUser.getUsernameGivenPlatform(platform: "Phone"));
...
//     return await usersCollection.doc(currSoshiUsername).update({"Profile Platforms": profilePlatforms});
//   }
...
//     }
//     return await usersCollection.doc(currSoshiUsername).update({"Choose Platforms": choosePlatformsList});
//   }
