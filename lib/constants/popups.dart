...
class Popups {
  ...
  static void editUsernamePopup(BuildContext context, SoshiUser user,
      Social platformSocial, double width) {
    String indicator;
    String hintText;
          ...
          return AlertDialog(
            ...
            title: Text(
              platformName.contains("Cryptowallet")
                  ...
                  : "Edit your " + platformName + " " + hintText,
            ),
            ...
            actions: <Widget>[
              Padding(
                ...
                child: TextButton(
                  ...
                  onPressed: () async {
                    platformSocial.username =
                        platformSocial.usernameController.text;
